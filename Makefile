...
.PHONY: build
build: fmt vet ## build interceptor and reporter binaries
	...
	CGO_ENABLED=0 GOOS=${HOST_OS} GOARCH=${HOST_ARCH} go build -v -ldflags '${LDFLAGS}' -o ${DIST_DIR}/edpreporter-${HOST_ARCH} ./cmd/reporter/main.go
