    ...
    for buildtool in ['dotnet']:
        for framework in ['dotnet-3.1']:
            for cbtype in ['app', 'lib']:
                ...
                assert "get-nexus-repository-url-dotnet" == btd[8]["taskRef"]["name"]
                ...
                assert "get-nexus-repository-url-dotnet" == btedp[9]["taskRef"]["name"]
    ...
    for buildtool in ['dotnet']:
        for framework in ['dotnet-3.1']:
            for cbtype in ['app']:
                ...
                assert "get-nexus-repository-url-dotnet" == btd[6]["taskRef"]["name"]
                ...
                assert "get-nexus-repository-url-dotnet" == btedp[7]["taskRef"]["name"]
