    ...
    for framework in ['dotnet-3.1', 'dotnet-6.0']:
        for cbtype in ['app', 'lib']:
            ...
            if cbtype == "app":
                ...
                assert "save-cache" in r[13]["name"]
            ...
            if cbtype == "app":
                ...
                assert "save-cache" in bd[14]["name"]
                assert "git-tag" in bd[15]["name"]
                assert "update-cbis" in bd[16]["name"]
            if cbtype == "lib":
                assert "save-cache" in bd[12]["name"]
            ...
            if cbtype == "app":
                ...
                assert "save-cache" in bedp[15]["name"]
  ...
  gitProvider: gitlab
    ...
    for framework in ['dotnet-3.1', 'dotnet-6.0']:
        for cbtype in ['app', 'lib']:
            ...
            assert f"get-version-dotnet-default" == bd[2]["taskRef"]["name"]
            assert "get-cache" in bd[3]["name"]
            assert "security" in bd[4]["name"]
            assert "build" in bd[5]["name"]
            ...
            assert "get-cache" in bedp[3]["taskRef"]["name"]
