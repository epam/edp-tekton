...
gerrit:
  enabled: true
    ...
    assert "gerrit-dotnet-dotnet-3.1-app-review" in r["pipeline"]
    assert "gerrit-dotnet-dotnet-3.1-app-build-default" in r["pipeline"]
    assert "gerrit-dotnet-dotnet-3.1-app-build-edp" in r["pipeline"]
