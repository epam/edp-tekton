  ...
  gitProviders:
    ...
    for buildtool in ['go']:
        for framework in ['beego', 'gin', 'operator-sdk']:
            ...
            assert "git-tag" in btd[9]["name"]
            assert "update-cbis" in btd[10]["name"]
            assert "gitlab-report-pipeline-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][0]["name"]
            ...
            assert "gitlab-report-pipeline-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][1]["name"]
  ...
  gitProviders:
    ...
    for buildtool in ['go']:
        for framework in ['beego', 'gin', 'operator-sdk']:
            ...
            assert "git-tag" in btd[9]["name"]
            assert "update-cbis" in btd[10]["name"]
            assert "bitbucket-report-pipeline-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][0]["name"]
            ...
            assert "update-cbis" in btedp[10]["name"]
            assert "update-cbb" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][0]["name"]
            assert "bitbucket-report-pipeline-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][1]["name"]
