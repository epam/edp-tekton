  ...
  gitProviders:
    ...
    for buildtool in ['go']:
        for framework in ['beego', 'gin', 'operator-sdk']:
            ...
            assert "gitlab-set-success-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][1]["name"]
            assert "gitlab-set-failure-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][2]["name"]
            ...
            assert "gitlab-set-success-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][2]["name"]
            assert "gitlab-set-failure-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][3]["name"]

def test_go_pipelines_harbor_bitbucket():
    config = """
global:
  gitProviders:
    - bitbucket
    ...
    for buildtool in ['go']:
        for framework in ['beego', 'gin', 'operator-sdk']:
            ...
            assert "update-cbis" in btd[10]["name"]
            assert "push-to-jira" in r["pipeline"][build_pipeline_def]["spec"]["finally"][0]["name"]
            assert "bitbucket-set-success-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][1]["name"]
            assert "bitbucket-set-failure-status" in r["pipeline"][build_pipeline_def]["spec"]["finally"][2]["name"]
            ...
            assert "update-cbb" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][0]["name"]
            assert "push-to-jira" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][1]["name"]
            assert "bitbucket-set-success-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][2]["name"]
            assert "bitbucket-set-failure-status" in r["pipeline"][build_pipeline_edp]["spec"]["finally"][3]["name"]
