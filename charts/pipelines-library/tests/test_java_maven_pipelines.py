    ...
    for buildtool in ['maven']:
        for framework in ['java8', 'java11', 'java17']:
            for cbtype in ['app', 'lib']:
                ...
                if cbtype == "app":
                    assert "get-maven-module" in rt[3]["name"]
                ...
                if cbtype == "app":
                    ...
                    assert "create-ecr-repository" in btedp[13]["name"]
                    assert "kaniko-build" in btedp[14]["name"]
                    assert "sast" in btedp[15]["name"]
    ...
    for buildtool in ['maven']:
        for framework in ['java8', 'java11', 'java17']:
            for cbtype in ['app', 'lib']:
                ...
                if cbtype == "app":
                    assert "get-maven-module" in btd[3]["name"]
