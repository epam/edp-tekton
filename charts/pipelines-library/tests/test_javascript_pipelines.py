...
gerrit:
  enabled: true
    ...
    assert "gerrit-npm-react-app-review" in r["pipeline"]
    assert "gerrit-npm-react-app-build-default" in r["pipeline"]
    assert "gerrit-npm-react-app-build-edp" in r["pipeline"]
