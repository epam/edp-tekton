    ...
    for buildtool in ['npm']:
        for framework in ['react', 'angular', 'vue', 'express', 'next']:
            for cbtype in ['app', 'lib']:
                ...
                assert "npm" in btd[5]["name"]
                assert "edp-npm" == btd[5]["taskRef"]["name"]
                ...
                assert "npm" in btedp[5]["name"]
                assert "edp-npm" == btedp[5]["taskRef"]["name"]
