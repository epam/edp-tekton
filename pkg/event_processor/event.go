...
// IsPullRequestUpdateEvent returns true if the event is a pull request update event
// (Bitbucket pullrequest:updated - fired for both code pushes and metadata-only edits).
